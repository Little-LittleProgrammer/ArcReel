...
MESSAGES: dict[str, str] = {
    ...
    "provider_name_bailian": "Alibaba Cloud Bailian",
    ...
    "provider_desc_bailian": "Alibaba Cloud Bailian (DashScope) provides Qwen text models plus Wan image and video generation for users in domestic network environments and the Alibaba Cloud ecosystem.",
}
